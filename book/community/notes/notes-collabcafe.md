...
**What?** *The Environmental Data Sense is a **community aiming to learn and discuss about good research practices to use existing Data Science and AI solutions to a better understanding of the planet earth across multiple environmental settings**. 
...
**Who?** ***Everyone** interested in reproducible, ethical, and inclusive Data Science and research for environmental studies are welcome to join the full or any part of The Environmental Data Sense project, community, and/or this call.*
...
* Main stage (silent mode)
    ...
    * Alejandro: 
        ...
        * checking which sample data within the Environmental Data Sense book can be curated in [the Environmental Data Sense Zenodo community](https://zenodo.org/communities/the-environmental-ds-community/?page=1&size=20).
...
* Alejandro: Deploying a FluxNet use case visualization outputs for the Environmental Data Sense book
