...
## Review
EiC will open a REVIEW issue containing some instructions, and reviewer checklists.
...
Comments in the REVIEW issue should be kept general with more lengthy suggestions or requests posted as separate issues, directly in the notebook repository. 
We encourage cross-referencing separate issues from the notebook repository with the REVIEW issue.

When the reviewers are satisfied with the improvements, the editor asks that they confirm their recommendation to accept the submission.
Then tag EiC to inform the notebook is ready to the post-print stage.